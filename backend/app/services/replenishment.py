    ...
    sql = text(
        ...
        inventory AS (
            SELECT
                ...
                MAX(COALESCE(NULLIF(di.manual_order_category, ''), di.replenishment_status_1)) AS status_1,
        ...
        SELECT
            ...
            COALESCE(inventory.status_1, NULLIF(dim_items.manual_order_category, ''), dim_items.replenishment_status_1) AS status_1,
