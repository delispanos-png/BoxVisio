    ...
    },
    {
        ...
        'steps': _tl(
            [
                ...
                'Δες τα KPIs + Store Health, μετά τις κάρτες δράσης: Χαμένες πωλήσεις (ταχυκίνητα εκτός αποθέματος → παραγγελία), Βαλτωμένο απόθεμα (δεσμευμένο κεφάλαιο → μεταφορά/έκπτωση), Έσοδα ανά κανάλι πώλησης και ανά ομάδα· Προτεινόμενες μεταφορές από άλλα καταστήματα (βάσει ταχύτητας κίνησης· η παραγγελία γίνεται από το FnR)· Κατηγορίες σε πτώση vs πέρσι.',
            ],
            [
