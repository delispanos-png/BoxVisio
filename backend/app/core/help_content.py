    ...
    },
    {
        ...
        'steps': _tl(
            [
                ...
                'Η «Ανά Κανάλι» δείχνει καθαρή αξία, συνεισφορά % και margin % ανά κανάλι πώλησης (Site, Wolt, Skroutz κ.λπ.· οι πωλήσεις χωρίς online κανάλι = «Φυσικό κατάστημα»), με τα ίδια φίλτρα και download.',
            ],
            [
