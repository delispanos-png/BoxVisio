    ...
    },
    {
        ...
        'steps': _tl(
            [
                ...
                'Η «Ευέλικτη Ανάλυση» είναι ένα report που το φτιάχνεις μόνος σου: διάλεξε «Ομαδοποίηση κατά» (κανάλι/ομάδα/brand/κατηγορία/κατάστημα/αποθήκη), τύπο (ανάλυση περιόδου ή σύγκριση Α/Β) και πρόσθεσε όσους δείκτες-στήλες θες από τη λίστα (καθαρή αξία, τεμάχια, κόστος, κέρδος, margin %, παραστατικά, ΦΠΑ κ.ά.). Ίδια φίλτρα και download.',
            ],
            [
