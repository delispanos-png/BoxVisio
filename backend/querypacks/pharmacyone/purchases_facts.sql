SELECT
  ...
  CAST(ISNULL(L.NETLINEVAL, ISNULL(L.NETVAL, ISNULL(L.NETAMNT, ISNULL(L.LINEVAL, 0)))) AS decimal(18,4)) AS net_amount,
  CAST(ISNULL(L.COSTVAL, ISNULL(L.COSTVALUE, ISNULL(L.LCOST, ISNULL(L.COST, ISNULL(L.NETLINEVAL, ISNULL(L.NETVAL, ISNULL(L.NETAMNT, ISNULL(L.LINEVAL, 0)))))))) AS decimal(18,4)) AS cost_amount,
  ...
  CAST(
    CASE
      WHEN SUM(ABS(ISNULL(L.VATAMNT, ISNULL(L.TAXAMNT, ISNULL(L.FPAAMNT, ISNULL(L.LINEVAT, ISNULL(L.LINETAX, ISNULL(L.LINEVATAMNT, ISNULL(L.LINETAXAMNT, 0))))))))) OVER (PARTITION BY F.FINDOC) > 0
        THEN ABS(ISNULL(L.VATAMNT, ISNULL(L.TAXAMNT, ISNULL(L.FPAAMNT, ISNULL(L.LINEVAT, ISNULL(L.LINETAX, ISNULL(L.LINEVATAMNT, ISNULL(L.LINETAXAMNT, 0))))))))
      WHEN NULLIF(SUM(ABS(ISNULL(L.NETLINEVAL, ISNULL(L.NETVAL, ISNULL(L.NETAMNT, ISNULL(L.LINEVAL, 0))))) ) OVER (PARTITION BY F.FINDOC), 0) IS NOT NULL
        THEN ABS(ISNULL(F.VATAMNT, 0))
             * ABS(ISNULL(L.NETLINEVAL, ISNULL(L.NETVAL, ISNULL(L.NETAMNT, ISNULL(L.LINEVAL, 0)))))
             / NULLIF(SUM(ABS(ISNULL(L.NETLINEVAL, ISNULL(L.NETVAL, ISNULL(L.NETAMNT, ISNULL(L.LINEVAL, 0))))) ) OVER (PARTITION BY F.FINDOC), 0)
      ELSE 0
    END AS decimal(18,4)
  ) AS vat_amount,
    ...
    ISNULL(
      ...
      ISNULL(
        ...
        ISNULL(
          ...
          ISNULL(
            L.LINEGROSS,
            ISNULL(L.NETLINEVAL, ISNULL(L.NETVAL, ISNULL(L.NETAMNT, ISNULL(L.LINEVAL, 0))))
            +
            CASE
              WHEN SUM(ABS(ISNULL(L.VATAMNT, ISNULL(L.TAXAMNT, ISNULL(L.FPAAMNT, ISNULL(L.LINEVAT, ISNULL(L.LINETAX, ISNULL(L.LINEVATAMNT, ISNULL(L.LINETAXAMNT, 0))))))))) OVER (PARTITION BY F.FINDOC) > 0
                THEN ABS(ISNULL(L.VATAMNT, ISNULL(L.TAXAMNT, ISNULL(L.FPAAMNT, ISNULL(L.LINEVAT, ISNULL(L.LINETAX, ISNULL(L.LINEVATAMNT, ISNULL(L.LINETAXAMNT, 0))))))))
