...
LEFT JOIN VAT VT WITH (NOLOCK)
  ON VT.VAT = I.VAT
LEFT JOIN CCCCATEGORY01 CT1 WITH (NOLOCK)
  ON CT1.CATEGORY01 = I.CCCCATEGORY01
LEFT JOIN CCCCATEGORY02 CT2 WITH (NOLOCK)
  ON CT2.CATEGORY02 = I.CCCCATEGORY02
LEFT JOIN CCCCATEGORY03 CT3 WITH (NOLOCK)
  ON CT3.CATEGORY03 = I.CCCCATEGORY03
