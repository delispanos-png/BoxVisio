SELECT
  ...
  CAST(ABS(ISNULL(L.SALESCVAL, ISNULL(L.NETLINEVAL, ISNULL(L.LINEVAL, 0)))) AS decimal(18,4)) AS cost_amount,
  CAST(ABS(ISNULL(L.NETLINEVAL, ISNULL(L.LINEVAL, 0))) AS decimal(18,4)) AS value_amount,
