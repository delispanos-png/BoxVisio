SELECT
  ...
  CAST(
    (CASE WHEN ISNULL(F.TFPRMS, 0) IN (151, 152, 181) THEN -1 ELSE 1 END)
    * ISNULL(L.COSTVAL, ISNULL(L.COSTVALUE, ISNULL(L.LCOST, ISNULL(L.COST, ISNULL(L.NETLINEVAL, ISNULL(L.NETVAL, ISNULL(L.NETAMNT, ISNULL(L.LINEVAL, 0))))))))
    AS decimal(18,4)
  ) AS cost_amount,
